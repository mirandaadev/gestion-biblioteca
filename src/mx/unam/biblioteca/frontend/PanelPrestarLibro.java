...
public class PanelPrestarLibro extends JPanel {
    ...
    public PanelPrestarLibro(List<Libro> listaLibros, List<Usuario> listaUsuarios, BibliotecaGUI ventanaPrincipal) {
        ...
        JButton buscarbtn = new JButton("Prestar");
        buscarbtn.addActionListener(e -> prestarLibro());
        ...
        try {
            ...
            if (libro.getCopiasDisponibles() > 0) {
                ...
                JOptionPane.showMessageDialog(this,
                        "Préstamo exitoso. '" + libro.getTitulo() + "' prestado a " + usuario.getNombre(), "Éxito",
                        JOptionPane.INFORMATION_MESSAGE);
                txtIdLibro.setText("");
                txtIdUsuario.setText("");
            } else {
                JOptionPane.showMessageDialog(this, "No hay copias disponibles de este libro.", "Error",
                        JOptionPane.ERROR_MESSAGE);
            }
